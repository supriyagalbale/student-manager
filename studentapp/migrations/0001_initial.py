# Generated by Django 2.1 on 2019-07-01 05:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batchcode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='studentapp.Batches')),
            ],
        ),
        migrations.AddField(
            model_name='payments',
            name='amdno',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='studentapp.Students'),
        ),
        migrations.AddField(
            model_name='batches',
            name='ccode',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='studentapp.Courses'),
        ),
    ]
